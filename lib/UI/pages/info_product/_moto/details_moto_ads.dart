...
class DetailsProducmotosads extends StatefulWidget {
  int index;
  DetailsProducmotosads({super.key, required this.index});

  @override
  State<DetailsProducmotosads> createState() => _DetailsStateProduct();
}

class _DetailsStateProduct extends State<DetailsProducmotosads> {
  final List imgList = [
