...
class DetailsProducmotos extends StatefulWidget {
  int index;
  DetailsProducmotos({super.key, required this.index});

  @override
  State<DetailsProducmotos> createState() => _DetailsStateProduct();
}

class _DetailsStateProduct extends State<DetailsProducmotos> {
  final List imgList = [
