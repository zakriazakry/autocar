...
class DetailsProducCars extends StatefulWidget {
  int index;
  DetailsProducCars({super.key, required this.index});

  @override
  State<DetailsProducCars> createState() => _DetailsStateProduct();
}

class _DetailsStateProduct extends State<DetailsProducCars> {
  final List imgList = [
