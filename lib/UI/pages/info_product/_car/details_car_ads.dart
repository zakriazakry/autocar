...
class DetailsProductADs extends StatefulWidget {
  int index;
  DetailsProductADs({super.key, required this.index});

  @override
  State<DetailsProductADs> createState() => _DetailsStateProduct();
}

class _DetailsStateProduct extends State<DetailsProductADs> {
  final List imgList = [
