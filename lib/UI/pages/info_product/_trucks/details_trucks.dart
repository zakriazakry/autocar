...
class DetailsProducTrucks extends StatefulWidget {
  int index;
  DetailsProducTrucks({super.key, required this.index});

  @override
  State<DetailsProducTrucks> createState() => _DetailsStateProduct();
}

class _DetailsStateProduct extends State<DetailsProducTrucks> {
  final List imgList = [
