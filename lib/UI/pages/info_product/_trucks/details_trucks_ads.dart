...
class DetailsProducTrucksads extends StatefulWidget {
  int index;
  DetailsProducTrucksads({super.key, required this.index});

  @override
  State<DetailsProducTrucksads> createState() => _DetailsStateProduct();
}

class _DetailsStateProduct extends State<DetailsProducTrucksads> {
  final List imgList = [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        IsAR() ? ar['102'].toString() : en['102'].toString(),
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 18,
                          color: isDark ? Colors.grey : color1,
