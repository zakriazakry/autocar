...
class DetailsProducpartsads extends StatefulWidget {
  int index;
  DetailsProducpartsads({super.key, required this.index});

  @override
  State<DetailsProducpartsads> createState() => _DetailsStateProduct();
}

class _DetailsStateProduct extends State<DetailsProducpartsads> {
  final List imgList = [
