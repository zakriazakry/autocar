...
class DetailsProducBoatsads extends StatefulWidget {
  int index;
  DetailsProducBoatsads({super.key, required this.index});

  @override
  State<DetailsProducBoatsads> createState() => _DetailsStateProduct();
}

class _DetailsStateProduct extends State<DetailsProducBoatsads> {
  final List imgList = [
