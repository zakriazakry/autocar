...
class DetailsProducBoats extends StatefulWidget {
  int index;
  DetailsProducBoats({super.key, required this.index});

  @override
  State<DetailsProducBoats> createState() => _DetailsStateProduct();
}

class _DetailsStateProduct extends State<DetailsProducBoats> {
  final List imgList = [
