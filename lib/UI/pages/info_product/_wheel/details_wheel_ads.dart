...
class DetailsProducwheelads extends StatefulWidget {
  int index;
  DetailsProducwheelads({super.key, required this.index});

  @override
  State<DetailsProducwheelads> createState() => _DetailsStateProduct();
}

class _DetailsStateProduct extends State<DetailsProducwheelads> {
  final List imgList = [
