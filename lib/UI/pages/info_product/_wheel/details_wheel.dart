...
class DetailsProducwheel extends StatefulWidget {
  int index;
  DetailsProducwheel({super.key, required this.index});

  @override
  State<DetailsProducwheel> createState() => _DetailsStateProduct();
}

class _DetailsStateProduct extends State<DetailsProducwheel> {
  final List imgList = [
